...
import 'config.dart';
import 'movie_details_text.dart';
...
class MovieListState extends State<MovieList> {
  ...
  void initState() {
    ...
    subscription = Connectivity()
      ...
      if (result.index==0) {
        _showDialog('No Internet Connrction','');
      }
    });
  }
                    ...
                    return new FlatButton(
                      ...
                      onPressed: () {
                        Navigator.push(context,
                          ...
                          return MovieDetailsText(movies[i]);
                        }));
                      },
                      color: Colors.white,
                    );
...
//  var checkInternet=networkCheck.check();
//  if (checkInternet==true || checkInternet !=null) {
...
class ListTileByMe extends StatelessWidget {
  final movies;
  final i;
  Color mainColor = const Color(0xff3C3261);
  var image_url = 'https://image.tmdb.org/t/p/w500/';
  ListTileByMe(this.movies, this.i);
